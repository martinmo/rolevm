 ...
 *
 * @implNote This class is a fork of {@link java.util.WeakHashMap}. Note that
 *           most {@link Map} operations have been removed and throw an
 ...
 * @author Martin Morgenstern (IdentityWeakHashMap)
...
public class IdentityWeakHashMap<K, V> implements Map<K, V> {
    ...
    private static class Entry<K, V> extends WeakReference<Object> implements Map.Entry<K, V> {
        ...
        @SuppressWarnings("unchecked")
        public K getKey() {
            return (K) IdentityWeakHashMap.unmaskNull(get());
        }
